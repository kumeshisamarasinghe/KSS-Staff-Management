...
public class Staff 
{
	...
	//execute the statement
		...
		{
			 output = "{\"status\":\"error\", \"data\": \"Error while inserting staff.\"}";
	...
	// execute the statement
		 ...
		 {
			 output = "{\"status\":\"error\", \"data\":\"Error while updating staff.\"}";
			 System.err.println(e.getMessage());
			 }
		 return output;
		 } 
	...
	// execute the statement
		...
		{
			 output = "{\"status\":\"error\", \"data\":\"Error while deleting staff.\"}";
			 System.err.println(e.getMessage());
			 }
		return output;
		}
