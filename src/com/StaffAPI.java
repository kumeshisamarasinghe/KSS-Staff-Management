...
public class StaffAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		{
			 String output = staffObj.insertStaff(request.getParameter("sname"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request);
		 ...
		 paras.get("sname").toString(),
		 paras.get("spassword").toString(),
		 paras.get("semail").toString(),
		paras.get("stel").toString(),
